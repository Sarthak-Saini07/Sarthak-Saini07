...
<img src="https://readme-typing-svg.demolab.com?font=JetBrains+Mono&weight=700&size=27&duration=2600&pause=900&color=39D353&center=true&vCenter=true&width=760&lines=Sarthak+Saini;Computer+Science+%7C+Cloud+%7C+DevOps;Building+projects+and+learning+every+day;AWS+%7C+Azure+%7C+Linux+%7C+Docker;Python+%7C+C+%7C+JavaScript+%7C+TypeScript" alt="Typing SVG">
...
cloud infrastructure, DevOps, automation and modern web technologies.

$ current_focus
Cloud • DevOps • Linux • Networking • Web Development • AI
```
...
- ☁️ Exploring **AWS & Microsoft Azure**
- 🐧 Working with **Linux, networking and system administration**
- ⚙️ Learning **Docker, Puppet, Git and automation**
- 🌐 Building with **HTML, CSS, JavaScript, TypeScript and React**
- 🐍 Using **Python** for development and automation
- 🗄️ Working with **MongoDB**
- 🚀 Interested in cloud-native development and DevOps
...
<img src="https://cdn.simpleicons.org/flask/white" width="55" height="55" alt="Flask">
</a>
...
<a href="https://www.puppet.com/">
<img src="https://cdn.simpleicons.org/puppet" width="55" height="55" alt="Puppet">
</a>
...
The technologies below represent the tools and frameworks used across my projects.

<div align="center">

| Project | Tech Stack |
|---|---|
| 🧠 **Dynamic Memory Visualizer** | `Python` |
| 💱 **Currency Converter Bot** | `Python` · `Flask` · `HTML` · `CSS` · `Jinja` · `Fixer.io API` |
| ⚡ **Neo Flux Convert** | `TypeScript` · `React` · `Tailwind CSS` · `Framer Motion` · `React Router` |
...
A currency conversion application using exchange-rate data through the Fixer.io API.

**Tech Stack**

`Python` `Flask` `HTML` `CSS` `Jinja` `Fixer.io API`
...
A modern conversion-focused frontend with responsive UI, routing and animations.

**Tech Stack**

`TypeScript` `React` `Tailwind CSS` `Framer Motion` `React Router`
